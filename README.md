...
קישור לתמונות ולמסך:https://docs.google.com/document/d/13lDH1US_YF19veqOgONKW8M_r5EmPT6e6RHXMbL0ktE/edit?tab=t.0
...
שיטות הכנסת נתונים  - התמונות בקישור
script python
...
גיבוי ושחזור נתונים - התמונות בקישור



שלב ב'
[מיניפ שלב ב'](./StepB/StepB_minip.pdf)
